...
char *generate_json_box(airc_box_dataPacket_S *data_recive)
{
    ...
    json_append_member(sensors_data, "co_err", json_mknumber(data_recive->co_err));
    ...
    json_append_member(sensors_data, "no2_err", json_mknumber(data_recive->no2_err));
    ...
    json_append_member(sensors_data, "so2_err", json_mknumber(data_recive->so2_err));
    ...
    json_append_member(sensors_data, "o3_err", json_mknumber(data_recive->o3_err));
